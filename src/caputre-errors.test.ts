...
describe('captureErrors function', () => {
  it('should capture errors from promises', async () => {
    ...
    expect(isPlainString).toBeUndefined();
  ...
  it('should capture parallel errors', async () => {
    ...
    expect(firstError.isPlainString).toBeUndefined();
    ...
    expect(secondError.isPlainString).toBeUndefined();
    ...
    expect(thirdError.isPlainString).toBeUndefined();
